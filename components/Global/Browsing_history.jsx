      ...
      <div className={classes["products_browsingHistory--EL"]}>
        <div className={classes["products_browsingHistory_content--CONTAINER"]}>
          ...
          {/* <div className={classes["products_carousel--CONTAINER"]}>
            <span className={`${classes["products_carousel_btn--CONTAINER"]} ${classes["left_carousel--CONTAINER"]}`}>
              <Link href="/" className={classes["left_carousel--BTN"]}>
            ...
            <div className={classes["products--CONTAINER"]}>
              <div className={classes["product_infos--EL"]}>
                <div className={classes["product_infos_content--CONTAINER"]}>
                  ...
                  <Link className={classes["product_reviews_link--EL"]} title="somtijinh" href="/product/reviews">
                      <div className={classes["product_reviews_stars--CONTAINER"]}>
                        <span className={`${classes["star--EL"]} ${classes["fullStar"]}`}></span>
                        <span className={`${classes["star--EL"]} ${classes["fullStar"]}`}></span>
                        <span className={`${classes["star--EL"]} ${classes["halfStar"]}`}></span>
                        <span className={`${classes["star--EL"]} ${classes["emptyStar"]}`}></span>
                        <span className={`${classes["star--EL"]} ${classes["emptyStar"]}`}></span>
                      </div>
                      <span>21,235</span>
                  </Link>
                  <Link href="/" className={`${classes["product_ranking--EL"]}`}>
                  ...
                  <Link href="/" className={classes["product_price--EL"]}>
                    $39.99
                  </Link>

                  <span className={classes["product_shipping_fee--EL"]}>$57.54 shipping</span>
                </div>
              </div>
            </div>

            <span className={`${classes["products_carousel_btn--CONTAINER"]} ${classes["right_carousel--CONTAINER"]}`}>
              <Link href="/" className={classes["left_carousel--BTN"]}>
